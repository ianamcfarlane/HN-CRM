...
interface Page {
    ...
    data: data;
    ui: ui;
    getAttribute(): Array; // Returns one or more controls depending on the arguments passed. 
    ...
    getAttribute(argument: AttributeFunctionCallback): Array; // Return Value The tab where the index matches the number
    getControl(): Array; // Returns one or more controls depending on the arguments passed. 
    ...
    getControl(argument: AttributeFunctionCallback): Array; // Return Value The tab where the index matches the number
}
...
interface TabsCollection {
    ...
    get(): Array; // Return Value All the tabs.
    ...
    get(argument: TabFunctionCallback): Array; // Return Value The tab where the index matches the number
...
interface TabSections {
    ...
    get(): Array; // Returns one or more controls depending on the arguments passed. 
    ...
    get(argument: AttributeFunctionCallback): Array; // Return Value The tab where the index matches the number
...
interface Context {
    ...
    getQueryStringParameters(): Array;  /// Returns an array of key value pairs representing the query string arguments that were passed to the page.
    ...
    getUserRoles(): Array; // Returns an array of strings representing the GUID values of each of the security roles that the user is associated with.
...
interface Control {
    ...
    getAttribute(): Array; //  Returns the attribute that the control is bound to.
