/// <reference path="Xrm2011.1_0.d.ts" />
    ...
    */
    export module Rest
    {
        ...
        */
        ...
        export function Create( object: Entity, type: string, successCallback: ( entity?: Entity ) => void , errorCallback: ( error: Error ) => void , async: boolean );
