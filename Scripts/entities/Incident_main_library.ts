...
function filterMaterialNumberByCustomer(bCalledByOnChange) {
    ...
    if ((oCust.getValue() != null && oDist.getValue() != null && (oCust.getValue()[0].id == oDist.getValue()[0].id)) || (oCust.getValue() != null && oDist.getValue() == null)) {
        ...
        var layoutXml = "<grid name='resultset' " +
            ...
            "preview='1'>" +
            "<row name='result' " +
            "id='ac_materialnumberid'>" + // Id attribute of the entity to be filtered
            "<cell name='ac_name' " + //Column1 - Salutation
            "width='300' />" +
            "</row>" +
            "</grid>";
        ...
        var layoutXml = "<grid name='resultset' " +
            ...
            "<row name='result' " +
            "id='ac_materialnumberid'>" + // Id attribute of the entity to be filtered
            "<cell name='ac_name' " + //Column1 - Name
            "width='300' />" +
            "</row>" +
            "</grid>";
...
function populateResponsibleTeamQueue() {
    if (Xrm.Page.getAttribute("ac_plantid").getValue() != null) {
        ...
        var layoutXml = "<grid name='resultset' " +
            ...
            "preview='1'>" +
            "<row name='result' " +
            "id='queueid'>" + // Id attribute of the entity to be filtered
            "<cell name='name' " + //Column1 - Salutation
            "width='300' />" +
            "</row>" +
            "</grid>";
...
function validateSubmit() {
    ...
    //Skip the secondary complaint type check if case type picklsit is other
